...
Represents an instance of a website rendered using Chromium embedded in the Smelter instance. It is utilized by a [WebView](/ts-sdk/1.0/components/webview) component.
