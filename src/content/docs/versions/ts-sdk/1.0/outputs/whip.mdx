...
* **Type**: [`WhipVideoOptions`](/ts-sdk/1.0/outputs/whip#whipvideooptions)
...
* **Type**: [`WhipAudioOptions`](/ts-sdk/1.0/outputs/whip#whipaudiooptions)
...
* **Type**: [`OutputEndCondition`](/ts-sdk/1.0/outputs/whip#outputendcondition)
...
* **Type**: [`WhipVideoEncoderOptions`](/ts-sdk/1.0/outputs/whip#whipvideoencoderoptions)
...
* **Type**: [`WhipAudioEncoderOptions`](/ts-sdk/1.0/outputs/whip#whipaudioencoderoptions)
