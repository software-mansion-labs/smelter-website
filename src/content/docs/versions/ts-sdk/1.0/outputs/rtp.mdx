...
* **Type**: [`RtpVideoOptions`](/ts-sdk/1.0/outputs/rtp#rtpvideooptions)
...
* **Type**: [`RtpAudioOptions`](/ts-sdk/1.0/outputs/rtp#rtpaudiooptions)
...
* **Type**: [`OutputEndCondition`](/ts-sdk/1.0/outputs/rtp#outputendcondition)
...
* **Type**: [`RtpVideoEncoderOptions`](/ts-sdk/1.0/outputs/rtp#rtpvideoencoderoptions)
...
* **Type**: [`RtpAudioEncoderOptions`](/ts-sdk/1.0/outputs/rtp#rtpaudioencoderoptions)
