...
slug: ts-sdk/1.0/ts-sdk/managers/node-locally-spawned
---
...
* For temporary downloads. See [`SMELTER_DOWNLOAD_DIR`](/ts-sdk/1.0/deployment/configuration#smelter_download_dir).
...
* It configures [`SMELTER_WEB_RENDERER_ENABLE`](/ts-sdk/1.0/deployment/configuration#smelter_web_renderer_enable) environment variable.
