...
To connect new input, register it first with [`Smelter.registerInput`](/ts-sdk/1.0/smelter#registerinput) and
...
* **Type**: [`InputWhipVideoOptions`](/ts-sdk/1.0/inputs/whip#inputwhipvideooptions)
...
* **Type**: [`InputWhipAudioOptions`](/ts-sdk/1.0/inputs/whip#inputwhipaudiooptions)
