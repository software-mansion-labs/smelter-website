...
<Steps>
  ...
  3. Register 2 input streams.
     ...
     logic would apply for any other [input type](/ts-sdk/1.0/overview#inputs).
  ...
  5. Modify the components to display both inputs.
     ...
     [`Tiles`](/ts-sdk/1.0/components/tiles) component is a simple way to display element in
